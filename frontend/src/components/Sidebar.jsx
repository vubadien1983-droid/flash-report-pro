  ...
  return (
    <div className="h-full flex flex-col bg-slate-900 text-slate-200 select-none">
      ...
      <div className="p-3 border-b border-slate-800/80 space-y-2">
        {/* ONE kind of report is created from here: a Flash Report. The CPP
            Mechanical Mini Plan and the OPS Findings report are single,
            long-lived documents — each exists once and is never re-created,
            so they are no longer offered as "new" (user request, v3.20.0). */}
        <button
          type="button"
          onClick={() => startNew('')}
